  ...
  <body>
    ...
    <div class="container">
		<div class="row clearfix" style="margin-top:30px;">
			...
			<div style="height:4px; background:#B22222; width:100%;"></div>
			...
			<!-- <div class="col-md-6 column" style="width:75%;"> -->	
				...
				<div style="position:relative; left:30px;">
					<c:forEach var="arts" items="${arts}">
						...
						<span style="font-size:18px; margin:10px;"><i style="font-size:16px;" class="fa fa-caret-right"></i> <a href="<c:url value="newsAndNotice-${arts.articleId}.html"/>" style="text-decoration:none;" target="_blank">${arts.articleTitle}</a></span><br/>
					</c:forEach>
					<hr style="height:1px;border:none;border-top:1px dashed #0066CC; margin:2px 0px;"/>
				</div>
