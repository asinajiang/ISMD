    ...
    <div class="container">
		<div class="row clearfix" style="margin-top:30px;">
			...
			<div class="col-md-6 column" style="width:75%;">	
				<h1 style="text-align:center;">${singleArt.articleTitle}</h1>
				<h6 style="text-align:center;">发表时间：<fmt:formatDate value="${singleArt.articleCreateTime}" pattern="yyyy-MM-dd"/></h6>
				<p>${singleArt.articleText}</p>
