	...
	<div class="container">
		<div class="row clearfix">
			...
			<div style="width:65px;" class="col-md-4 column">
				 <a target="_blank" href="<c:url value="/newsAndNoticeList-25.html"/>" style="text-decoration: none;"><button type="button" class="btn btn-info btn-default btn-block">更多>></button></a>
			</div>
		</div>
		<div class="row clearfix">
		    ...
		    <c:forEach var="articles" items="${articles}">
		        <div class="col-md-4 column">
					...
					<a target="_blank" href="<c:url value="/newsAndNotice-${articles.articleId}.html"/>">
					...
					<p>
						 <a target="_blank" class="btn" href="<c:url value="/newsAndNotice-${articles.articleId}.html"/>">View details »</a>
					</p>
			    </div>
		    </c:forEach>
		...
		<div class="row clearfix">
			<div class="col-md-6 column">
				...
				<div class="row clearfix">
					...
					<div style="width:65px;" class="col-md-4 column">
						 <a target="_blank" href="<c:url value="/newsAndNoticeList-26.html"/>" style="text-decoration: none;"><button type="button" class="btn btn-default btn-block btn-info">更多>></button></a>
					</div>
				</div>
				<div style="height:3px; background:#551A8B;"></div>
				...
				<div class="media well">
					 <a target="_blank" href="<c:url value="/newsAndNotice-${notices.articleId}.html"/>" class="pull-left" style="text-decoration: none;">
					     <div style="border:1px solid #EE7621; width:57px; heigth:55px;"class="media-object">   <!-- 通知公告日期显示 -->
                             <div style="width:55px; height:35px; background:#EE7621; font-size:26px; color:white; text-align:center;" class="ye-mon-day"><fmt:formatDate value="${notices.articleCreateTime}" pattern="dd"/></div>
                             <div style="width:55px; height:20px; fontsize:20px; color:#EE7621"><fmt:formatDate value="${notices.articleCreateTime}" pattern="yyyy-MM"/></div>
                         </div>
                    </a>
					<div class="media-body">
						${notices.articleTitle}<br/>
						时间：<fmt:formatDate value="${notices.articleCreateTime}" pattern="yyyy-MM-dd"/><br/>
						${notices.articleKeyWords}
					</div>
				</div>
